    ...
    <div className="relative">
      <button
        ...
        className={cn(
          ...
          open ? 'bg-[var(--surface-active)] text-white' : 'text-[var(--text-muted)] hover:bg-[var(--surface-hover)] hover:text-white'
        )}
      ...
      {open && (
        <div className="absolute bottom-full left-0 mb-2 w-[280px] rounded-xl border border-[var(--border-default)] bg-[var(--surface-2)] shadow-xl animate-in fade-in slide-in-from-bottom-2 overflow-hidden">
