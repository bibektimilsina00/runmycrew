...
from apps.api.app.schemas.asset import AssetStats, AssetUpdate
...
class AssetService:
    ...
    async def update_asset(self, asset_id: uuid.UUID, workspace: Workspace, data: AssetUpdate) -> Asset:
