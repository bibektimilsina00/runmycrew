...
MANIFEST = ProviderManifest(
    ...
    operations=[
        ...
        OpSpec(
            ...
            method="GET",
            path="{project_url}/rest/v1/{table}",
            visible_fields=["table", "search_column", "search_query"],
            query_builder=lambda v: {
                k: val
                for k, val in {
        ...
        OpSpec(
            ...
            method="POST",
            path="{project_url}/rest/v1/rpc/{function_name}",
        ...
        OpSpec(
            ...
            method="POST",
            path="{project_url}/functions/v1/{function_name}",
        ...
        OpSpec(
            ...
            method="POST",
            path="{project_url}/storage/v1/object/{bucket_name}/{storage_path}",
        ...
        OpSpec(
            ...
            method="POST",
            path="{project_url}/storage/v1/object/list/{bucket_name}",
        ...
        OpSpec(
            ...
            method="POST",
            path="{project_url}/storage/v1/object/move",
        ...
        OpSpec(
            ...
            method="POST",
            path="{project_url}/storage/v1/object/copy",
            visible_fields=["bucket_name", "storage_path", "storage_destination"],
            body_builder=lambda v: {
                "bucketId": getattr(v, "bucket_name", "") or "",
                "sourceKey": getattr(v, "storage_path", "") or "",
        ...
        OpSpec(
            ...
            method="GET",
            path="{project_url}/storage/v1/object/public/{bucket_name}/{storage_path}",
            visible_fields=["bucket_name", "storage_path"],
            query_builder=lambda v: {},
        ),
        OpSpec(
            ...
            method="POST",
            path="{project_url}/storage/v1/object/sign/{bucket_name}/{storage_path}",
        ...
        OpSpec(
            ...
            method="POST",
            path="{project_url}/storage/v1/bucket",
        ...
        OpSpec(
            ...
            method="DELETE",
            path="{project_url}/storage/v1/bucket/{bucket_name}",
