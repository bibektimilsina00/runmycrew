...
MANIFEST = ProviderManifest(
    ...
    fields=[
        ...
        FieldSpec(name="audiobook_id", label="Audiobook ID", type="string"),
        FieldSpec(name="chapter_id", label="Chapter ID", type="string"),
        FieldSpec(name="seed_artists", label="Seed Artists (comma-separated)", type="string"),
        FieldSpec(name="seed_genres", label="Seed Genres (comma-separated)", type="string"),
        FieldSpec(name="seed_tracks", label="Seed Tracks (comma-separated)", type="string"),
        FieldSpec(name="device_ids", label="Device IDs (JSON array)", type="json", default=[]),
    ],
    operations=[
        OpSpec(
            id="search",
        ...
        OpSpec(
            ...
            label="Get Audiobook",
            method="GET",
            path="/audiobooks/{audiobook_id}",
            visible_fields=["audiobook_id"],
            query_builder=lambda v: {},
        ),
        OpSpec(
            id="get_audiobooks",
        ...
        OpSpec(
            id="get_audiobook_chapters",
            label="Get Audiobook Chapters",
            method="GET",
            path="/audiobooks/{audiobook_id}/chapters",
            visible_fields=["audiobook_id"],
            query_builder=lambda v: {},
        ),
        OpSpec(
            id="get_saved_audiobooks",
        ...
        OpSpec(
            ...
            visible_fields=["seed_artists", "seed_genres", "seed_tracks", "limit"],
            query_builder=lambda v: {
                k: val
                for k, val in {
                    "seed_artists": getattr(v, "seed_artists", None) or None,
                    "seed_genres": getattr(v, "seed_genres", None) or None,
                    "seed_tracks": getattr(v, "seed_tracks", None) or None,
        ...
        OpSpec(
            ...
            method="PUT",
            path="/me/player",
            visible_fields=["device_ids"],
            body_builder=lambda v: {"device_ids": getattr(v, "device_ids", []) or []},
        ),
        OpSpec(
            id="check_follow_playlist",
            label="Check Follow Playlist",
            method="GET",
            path="/playlists/{playlist_id}/followers/contains",
            visible_fields=["playlist_id", "ids"],
            query_builder=lambda v: {"ids": getattr(v, "ids", "") or ""},
        ),
        OpSpec(
            id="follow_playlist",
