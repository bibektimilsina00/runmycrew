"""ElevenLabs action node — ElevenLabs — TTS, voice cloning, speech-to-speech.

REST at https://api.elevenlabs.io/v1. See sim-parity roadmap Phase 4-close-5.
"""
...
MANIFEST = ProviderManifest(
    type="action.elevenlabs",
    name="ElevenLabs",
    category="integration",
    description="ElevenLabs — TTS, voice cloning, speech-to-speech.",
    icon_slug="elevenlabs",
    color="#ffffff",
    base_url="https://api.elevenlabs.io/v1",
    credential_type="elevenlabs_api_key",
    token_field=["api_key"],
    auth="header_token",
    ...
    operations=[
        OpSpec(
            ...
            visible_fields=["voice_id", "text", "model_id"],
            body_builder=lambda v: {
                "text": getattr(v, "text", "") or "",
                "model_id": getattr(v, "model_id", None) or "eleven_multilingual_v2",
            },
        ),
        OpSpec(
            id="list_voices",
        ...
        OpSpec(
            ...
            method="POST",
            path="/speech-to-text",
            visible_fields=["file_url", "model_id"],
            body_builder=lambda v: {
                "model_id": getattr(v, "model_id", None) or "scribe_v1",
