"""Bright Data action node — Bright Data — proxy + web scraping API.

REST at https://api.brightdata.com. See sim-parity roadmap Phase 4.18/4.19.
"""
...
MANIFEST = ProviderManifest(
    ...
    credential_type="brightdata_api_key",
    token_field=["api_key"],
    auth="bearer",
    fields=[
    ...
    operations=[
        OpSpec(
            ...
            visible_fields=["dataset_id", "url"],
            body_builder=lambda v: {
                "dataset_id": getattr(v, "dataset_id", "") or "",
                "input": [{"url": getattr(v, "url", "") or ""}],
            },
        ),
        OpSpec(
            id="get_snapshot",
