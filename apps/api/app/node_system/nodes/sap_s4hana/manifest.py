...
MANIFEST = ProviderManifest(
    ...
    fields=[
        ...
        FieldSpec(name="bp_body", label="Business Partner Body (JSON)", type="json", default={}),
        FieldSpec(name="so_body", label="Sales Order Body (JSON)", type="json", default={}),
        FieldSpec(name="po_body", label="Purchase Order Body (JSON)", type="json", default={}),
    ],
    operations=[
        OpSpec(
        ...
        OpSpec(
            ...
            method="POST",
            path="/API_BUSINESS_PARTNER/A_BusinessPartner",
            visible_fields=["bp_body"],
            body_builder=lambda v: getattr(v, "bp_body", None) or {},
        ),
        OpSpec(
            id="update_business_partner",
            label="Update Business Partner",
            method="PATCH",
            path="/API_BUSINESS_PARTNER/A_BusinessPartner('{business_partner}')",
            visible_fields=["business_partner", "bp_body"],
            body_builder=lambda v: getattr(v, "bp_body", None) or {},
        ),
        OpSpec(
            id="delete_business_partner",
        ...
        OpSpec(
            ...
            method="POST",
            path="/API_SALES_ORDER_SRV/A_SalesOrder",
            visible_fields=["so_body"],
            body_builder=lambda v: getattr(v, "so_body", None) or {},
        ),
        OpSpec(
            ...
            method="PATCH",
            path="/API_SALES_ORDER_SRV/A_SalesOrder('{sales_order}')",
            visible_fields=["sales_order", "so_body"],
            body_builder=lambda v: getattr(v, "so_body", None) or {},
        ),
        OpSpec(
            id="list_customer_material_infos",
            label="List Customer Material Infos",
            method="GET",
            path="/API_CUSTOMER_MATERIAL_SRV/A_CustomerMaterial",
            visible_fields=[],
            query_builder=lambda v: {},
        ),
        OpSpec(
            id="list_pricing_conditions",
            label="List Pricing Conditions",
            method="GET",
            path="/API_PRICING_CONDITION_SRV/A_ConditionRecord",
            visible_fields=[],
            query_builder=lambda v: {},
        ),
        OpSpec(
            id="list_deliveries_docs",
            label="List Outbound Delivery Items",
            method="GET",
            path="/API_OUTBOUND_DELIVERY_SRV/A_OutbDeliveryItem",
            visible_fields=[],
            query_builder=lambda v: {},
        ),
        OpSpec(
            id="list_inbound_deliveries",
            label="List Inbound Deliveries",
            method="GET",
            path="/API_INBOUND_DELIVERY_SRV/A_InbDeliveryHeader",
            visible_fields=[],
            query_builder=lambda v: {},
        ),
        OpSpec(
            ...
            method="POST",
            path="/API_PURCHASEORDER_PROCESS_SRV/A_PurchaseOrder",
            visible_fields=["po_body"],
            body_builder=lambda v: getattr(v, "po_body", None) or {},
        ),
        OpSpec(
        ...
        OpSpec(
            ...
            method="GET",
            path="/API_GLACCOUNTINCHARTOFACCOUNTS_SRV/A_GLAccountInChartOfAccounts",
            visible_fields=[],
            query_builder=lambda v: {},
        ),
        OpSpec(
            id="list_material_stocks",
            label="List Material Stocks",
            method="GET",
            path="/API_MATERIAL_STOCK_SRV/A_MaterialStock",
            visible_fields=[],
            query_builder=lambda v: {},
        ),
        OpSpec(
            id="list_material_valuations",
            label="List Material Valuations",
            method="GET",
            path="/API_MATERIAL_VALUATION_SRV/A_MaterialValuation",
            visible_fields=[],
            query_builder=lambda v: {},
        ),
        OpSpec(
            ...
            method="GET",
            path="/API_ORGANIZATIONALUNIT_SRV/A_OrganizationalUnit",
            visible_fields=[],
            query_builder=lambda v: {},
        ),
        OpSpec(
            id="list_currency_rates",
            label="List Currency Exchange Rates",
            method="GET",
            path="/API_EXCHANGERATE_SRV/ExchangeRate",
            visible_fields=[],
            query_builder=lambda v: {},
        ),
        OpSpec(
            id="list_workflow_tasks",
            label="List Workflow Tasks",
            method="GET",
            path="/API_WORKFLOW_TASK_SRV/WorkflowTaskCollection",
            visible_fields=[],
            query_builder=lambda v: {},
        ),
        OpSpec(
            id="list_document_flows",
            label="List Document Flows",
            method="GET",
            path="/API_SALES_ORDER_SRV/A_SalesOrderDocumentFlow",
            visible_fields=[],
            query_builder=lambda v: {},
        ),
        OpSpec(
            id="list_shipping_types",
            label="List Shipping Types",
            method="GET",
            path="/API_SHIPPINGTYPE_SRV/ShippingType",
            visible_fields=[],
            query_builder=lambda v: {},
        ),
        OpSpec(
            id="list_incoterms",
            label="List Incoterms",
            method="GET",
            path="/API_INCOTERM_SRV/IncotermsClassification",
            visible_fields=[],
            query_builder=lambda v: {},
        ),
    ],
