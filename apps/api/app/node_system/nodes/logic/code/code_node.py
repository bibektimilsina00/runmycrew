        ...
        return NodeMetadata(
            ...
            properties=[
                ...
                },
                {
                    ...
                    "description": "Python: set `output` dict. Use `{{$step.field}}` or `{{$node('Label').field}}` to reference previous nodes.",
                ...
                },
                {
                    ...
                    "required": True,
                    "default": "// Access previous node data via `input`\n// Set `output` to pass data to the next node\noutput = { result: input };",
                    "description": "JavaScript: set `output` object. Use {{$step.field}} or {{$node('Label').field}} to reference previous nodes.",
