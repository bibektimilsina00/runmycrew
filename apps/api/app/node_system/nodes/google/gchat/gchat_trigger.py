...
from apps.api.app.node_system.nodes.google.gchat import COLOR, ICON_SLUG, NAME
...
class GoogleChatTriggerProperties(BaseModel):
    ...
    def _coerce_space(cls, value: Any) -> str:
        from apps.api.app.node_system.nodes.google.gchat.gchat_node import _to_space_name
