...
MANIFEST = ProviderManifest(
    ...
    fields=[
        ...
        FieldSpec(name="event_payload", label="Event Payload (JSON)", type="json", default={}),
    ...
    operations=[
        ...
        OpSpec(
            id="cancel_all_runs",
            label="Cancel All Runs for Task",
            method="POST",
            path="/tasks/{task_id}/runs/cancel-all",
            visible_fields=["task_id"],
            body_builder=lambda v: {},
        ),
        OpSpec(
            ...
            label="Expire Run",
            method="POST",
            path="/runs/{run_id}/expire",
            visible_fields=["run_id"],
            body_builder=lambda v: {},
        ),
        OpSpec(
            id="update_run_metadata",
            label="Update Run Metadata",
            method="PUT",
            path="/runs/{run_id}/metadata",
            visible_fields=["run_id", "metadata"],
            body_builder=lambda v: getattr(v, "metadata", None) or {},
        ),
        OpSpec(
            id="get_run_metadata",
        ...
        OpSpec(
            id="list_run_attempts",
            label="List Run Attempts",
            method="GET",
        ...
        OpSpec(
            id="get_current_run",
            label="Get Current Run (from JWT)",
            method="GET",
            path="/runs/current",
            visible_fields=[],
            query_builder=lambda v: {},
        ...
        OpSpec(
            id="list_run_tags_across",
            label="List Run Tags (across all)",
            method="GET",
            path="/run-tags",
            visible_fields=[],
            query_builder=lambda v: {},
        ...
        OpSpec(
            ...
            method="POST",
            path="/events",
            visible_fields=["event_name", "event_payload"],
            body_builder=lambda v: {
                "name": getattr(v, "event_name", "") or "",
                "payload": getattr(v, "event_payload", None) or {},
            },
        ),
        OpSpec(
            id="get_event",
