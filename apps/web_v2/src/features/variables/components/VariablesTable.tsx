  ...
  return (
    <div className="panel">
      <div className="table table-vars">
        ...
        {items.length === 0 && (
          <div className="flex flex-col items-center gap-2 py-10 border-t border-[var(--border-faint)]">
            <Icons.Key style={{ width: 18, height: 18, color: 'var(--text-dim)' }} />
            <span className="text-[13px] text-[var(--text-faint)]">No variables yet.</span>
          </div>
        )}
